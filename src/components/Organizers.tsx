...
export function Organizers() {
  const team = [
    ...
    },
    {
      ...
      role: 'Organizer',
      image:
        'https://res.cloudinary.com/startup-grind/image/upload/c_fill,w_250,h_250,g_center/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-goog/avatars/vatsal_jain_9uuB5SU.jpg',
  ...
  return (
    <section id="organizers" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
          ...
          {team.map((member, index) => (
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                {/* ROLE TEXT – MATCHES CARD COLOR */}
                <p
                  className={`text-sm mb-3 font-medium ${
                    roleTextColors[
                      member.color as keyof typeof roleTextColors
                    ]
                  }`}
                >
                  {member.role}
                  ...
                  {member.linkedin && (
                    <a
                      ...
                      className={`w-8 h-8 rounded-full bg-gray-200 ${
                        socialColors[
                          member.color as keyof typeof socialColors
                        ]
